...
print "open","\n";
my $dir="/data/ted/multi/coca/";
open SEQ, ">${dir}seq_open.txt" or die "Can't open output file ${dir}seq.txt";
#open SEQ_bg, ">${dir}seq_bg_open_rc.txt" or die "Can't open output file ${dir}seq.txt";
#open LABEL, ">${dir}label_open_rc.txt" or die "Can't open output file ${dir}label.txt";
#open SAM, ">${dir}sample_open_rc.txt" or die "Can't open output file ${dir}sample.txt";
#open MID, ">${dir}mid_open_rc.txt" or die "Can't open output file ${dir}mid.txt";
...
#open OUT, ">${dir}sample_hash_open_rc.txt" or die "Can't open output file ${dir}XRXS.sample.txt";
